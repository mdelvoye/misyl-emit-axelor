...
public class SaleOrder extends AuditableModel {
	...
	@Widget(title = "Total gross margin")
	private BigDecimal totalGrossMargin = BigDecimal.ZERO;

	@Widget(title = "Margin rate")
	...
	@Widget(title = "Total Brut")
	private BigDecimal exTaxTotalPrimary = BigDecimal.ZERO;

	@Widget(title = "Total Eco Taxe")
	private BigDecimal exTaxTotalEcoTax = BigDecimal.ZERO;
	...
	public BigDecimal getExTaxTotalPrimary() {
		return exTaxTotalPrimary == null ? BigDecimal.ZERO : exTaxTotalPrimary;
	}

	public void setExTaxTotalPrimary(BigDecimal exTaxTotalPrimary) {
		this.exTaxTotalPrimary = exTaxTotalPrimary;
	}

	public BigDecimal getExTaxTotalEcoTax() {
		return exTaxTotalEcoTax == null ? BigDecimal.ZERO : exTaxTotalEcoTax;
	}

	public void setExTaxTotalEcoTax(BigDecimal exTaxTotalEcoTax) {
		this.exTaxTotalEcoTax = exTaxTotalEcoTax;
	}
