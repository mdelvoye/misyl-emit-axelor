...
@Entity
@Table(name = "BASE_PRODUCT", indexes = { @Index(columnList = "name"), @Index(columnList = "code"), @Index(columnList = "picture"), @Index(columnList = "product_category"), @Index(columnList = "product_family"), @Index(columnList = "unit"), @Index(columnList = "sale_currency"), @Index(columnList = "purchase_currency"), @Index(columnList = "product_variant_config"), @Index(columnList = "product_variant"), @Index(columnList = "parent_product"), @Index(columnList = "default_supplier_partner"), @Index(columnList = "bar_code"), @Index(columnList = "barcode_type_config"), @Index(columnList = "fullName"), @Index(columnList = "weight_unit"), @Index(columnList = "length_unit"), @Index(columnList = "sales_unit"), @Index(columnList = "purchases_unit"), @Index(columnList = "tracking_number_configuration"), @Index(columnList = "customs_code_nomenclature"), @Index(columnList = "mrp_family") })
...
public class Product extends AuditableModel {
	...
	@Widget(title = "Eco Taxe", massUpdate = true)
	@Digits(integer = 10, fraction = 10)
	private BigDecimal productEcoTax = BigDecimal.ZERO;
	...
	public Boolean getIsPack() {
		return isPack == null ? Boolean.FALSE : isPack;
	}
	...
	public BigDecimal getProductEcoTax() {
		return productEcoTax == null ? BigDecimal.ZERO : productEcoTax;
	}

	public void setProductEcoTax(BigDecimal productEcoTax) {
