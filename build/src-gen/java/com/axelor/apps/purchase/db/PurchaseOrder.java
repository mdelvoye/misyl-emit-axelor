...
@DynamicInsert
@DynamicUpdate
@Table(name = "PURCHASE_PURCHASE_ORDER", uniqueConstraints = { @UniqueConstraint(columnNames = { "purchaseOrderSeq", "company" }) }, indexes = { @Index(columnList = "fullName"), @Index(columnList = "company"), @Index(columnList = "supplier_partner"), @Index(columnList = "contact_partner"), @Index(columnList = "price_list"), @Index(columnList = "buyer_user"), @Index(columnList = "currency"), @Index(columnList = "validated_by_user"), @Index(columnList = "company_bank_details"), @Index(columnList = "trading_name"), @Index(columnList = "printing_settings"), @Index(columnList = "shipment_mode"), @Index(columnList = "freight_carrier_mode"), @Index(columnList = "invoice"), @Index(columnList = "payment_mode"), @Index(columnList = "payment_condition"), @Index(columnList = "stock_location"), @Index(columnList = "budget") })
...
public class PurchaseOrder extends AuditableModel {
	...
	public Boolean getPriceDisplay() {
		return priceDisplay == null ? Boolean.FALSE : priceDisplay;
	}
