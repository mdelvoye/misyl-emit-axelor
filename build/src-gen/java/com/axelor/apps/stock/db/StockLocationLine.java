...
@Entity
@Table(name = "STOCK_STOCK_LOCATION_LINE", indexes = { @Index(columnList = "stock_location"), @Index(columnList = "product"), @Index(columnList = "tracking_number"), @Index(columnList = "details_stock_location") })
