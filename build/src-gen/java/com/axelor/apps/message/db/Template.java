...
@Entity
@Table(name = "MESSAGE_TEMPLATE", indexes = { @Index(columnList = "name"), @Index(columnList = "meta_model"), @Index(columnList = "template_context"), @Index(columnList = "birt_template"), @Index(columnList = "language") })
